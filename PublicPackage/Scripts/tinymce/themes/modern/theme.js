...
tinymce.ThemeManager.add('modern', function(editor) {
	...
	var defaultMenus = {
		...
		edit: {title: 'Редактировать', items: 'undo redo | cut copy paste pastetext | selectall'},
		insert: {title: 'Вставить', items: '|'},
	...
	var defaultToolbar = "undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | " +
		"bullist numlist outdent indent | link image | code | link | forecolor backcolor | image imagetools";
