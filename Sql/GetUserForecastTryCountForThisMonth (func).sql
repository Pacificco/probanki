-- Возвращает количестов прогнозов, в которых пользователь может принять участие в текущем месяце
...
-- Возвращает количестов прогнозов, в которых пользователь может сейчас принять участие
