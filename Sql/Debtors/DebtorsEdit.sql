...
create proc DebtorsEdit (
	...
	@Locality				nvarchar(255),			-- Населенный пункт: вводится в ручную при заполнении
	...
	@ContactPerson			nvarchar(255),			-- Контактное лицо: вводится в ручную при заполнении
	@ContactPhone			bigint,					-- Контактный телефон: вводится в ручную при заполнении
	@DopPhone				bigint,					-- Дополнительный контактный телефон: вводится в ручную при заполнении
	@Email					varchar(129),			-- Email: вводится в ручную при заполнении
	@Comment				nvarchar(2000)			-- Дополнительный комментарий	
) as	
begin	
