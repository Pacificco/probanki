...
namespace Bankiru.Models.Domain.Users
{
    public class VM_UserProfileInfo
    {
        ...
        public List<VM_UserForecast> ForecastsForMonth { get; set; }
        ...
        public VM_UserProfileInfo()
        {
            ...
            ForecastsForMonth = new List<VM_UserForecast>();
            Clear();
        }
        public void Clear()
        {
        ...
        public List<VM_UserForecast> GetForecastsBySubject(int subjectId)
        {
            if (ForecastsForMonth.Count == 0)
                return null;
            List<VM_UserForecast> result = (from f in ForecastsForMonth where f.Forecast.SubjectId == subjectId select f).ToList<VM_UserForecast>();
